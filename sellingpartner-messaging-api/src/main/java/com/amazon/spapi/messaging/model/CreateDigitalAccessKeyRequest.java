...
package com.amazon.spapi.messaging.model;

import java.util.Objects;
import java.util.Arrays;
import com.amazon.spapi.messaging.model.Attachment;
...
public class CreateDigitalAccessKeyRequest {
   ...
   * @return text
  **/
  @ApiModelProperty(value = "The text to be sent to the buyer. Only links related to the digital access key are allowed. Do not include HTML or email addresses.")
