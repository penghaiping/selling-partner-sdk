...
public class CreateConfirmCustomizationDetailsRequest {
   ...
   * @return text
  **/
  @ApiModelProperty(value = "The text to be sent to the buyer. Only links related to customization details are allowed. Do not include HTML or email addresses.")
