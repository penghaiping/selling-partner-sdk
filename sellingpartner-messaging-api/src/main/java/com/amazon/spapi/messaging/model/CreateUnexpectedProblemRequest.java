...
public class CreateUnexpectedProblemRequest {
   ...
   * @return text
  **/
  @ApiModelProperty(value = "The text to be sent to the buyer. Only links related to unexpected problem calls are allowed. Do not include HTML or email addresses.")
