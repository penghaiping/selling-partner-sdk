...
package com.amazon.spapi.fulfillmentinbound.api;
...
import com.amazon.spapi.fulfillmentinbound.model.ConfirmPreorderResponse;
import com.amazon.spapi.fulfillmentinbound.model.ConfirmTransportResponse;
import com.amazon.spapi.fulfillmentinbound.model.CreateInboundShipmentPlanRequest;
import com.amazon.spapi.fulfillmentinbound.model.CreateInboundShipmentPlanResponse;
import com.amazon.spapi.fulfillmentinbound.model.EstimateTransportResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetBillOfLadingResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetInboundGuidanceResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetLabelsResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetPreorderInfoResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetPrepInstructionsResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetShipmentItemsResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetShipmentsResponse;
import com.amazon.spapi.fulfillmentinbound.model.GetTransportDetailsResponse;
import com.amazon.spapi.fulfillmentinbound.model.InboundShipmentRequest;
import com.amazon.spapi.fulfillmentinbound.model.InboundShipmentResponse;
import org.threeten.bp.LocalDate;
import org.threeten.bp.OffsetDateTime;
import com.amazon.spapi.fulfillmentinbound.model.PutTransportDetailsRequest;
import com.amazon.spapi.fulfillmentinbound.model.PutTransportDetailsResponse;
import com.amazon.spapi.fulfillmentinbound.model.VoidTransportResponse;
...
public class FbaInboundApi {
    ...
    private com.squareup.okhttp.Call getLabelsValidateBeforeCall(String shipmentId, String pageType, String labelType, Integer numberOfPackages, List<String> packageLabelsToPrint, Integer numberOfPallets, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLabelsCall(shipmentId, pageType, labelType, numberOfPackages, packageLabelsToPrint, numberOfPallets, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetLabelsResponse> getLabelsWithHttpInfo(String shipmentId, String pageType, String labelType, Integer numberOfPackages, List<String> packageLabelsToPrint, Integer numberOfPallets) throws ApiException {
        com.squareup.okhttp.Call call = getLabelsValidateBeforeCall(shipmentId, pageType, labelType, numberOfPackages, packageLabelsToPrint, numberOfPallets, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getLabelsAsync(String shipmentId, String pageType, String labelType, Integer numberOfPackages, List<String> packageLabelsToPrint, Integer numberOfPallets, final ApiCallback<GetLabelsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLabelsValidateBeforeCall(shipmentId, pageType, labelType, numberOfPackages, packageLabelsToPrint, numberOfPallets, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetLabelsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
