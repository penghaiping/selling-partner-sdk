...
import com.amazon.spapi.feeds.model.FeedOptions;
...
public class CreateFeedSpecification {
  ...
  **/
  @ApiModelProperty(required = true, value = "The document identifier returned by the createFeedDocument operation. Encrypt and upload the feed document contents before calling the createFeed operation.")
